...
ejemplo :-
    A is 45,
    new(D, dialog('Neuro Expert')),
    new(L, label(nombre, 'Trabajo 1 - Lenguajes de Programación')),
    new(B, button('Diagnosticar',
                  message(@prolog, mostrar_mensaje, A, 'Hola'))),
    new(B2, button('Cerrar Ventana',
